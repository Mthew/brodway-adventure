 ...
 *
 * Extraído de `app/admin/destinos/[id]/editar/page.tsx` (N-01.0b): esa ruta ahora
 * sólo importa y renderiza `EditarDestino`.
 */
export default async function EditarDestino({
  params,
  searchParams,
}: {
