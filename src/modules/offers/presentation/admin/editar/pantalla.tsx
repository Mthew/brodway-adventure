...
import { Error as ErrorMensaje } from "@/src/platform/admin/piezas";
 ...
 * `Avance`, `src/platform/admin/piezas.tsx`): antes apuntaba a una ruta que nunca
 * existió (`/admin/ofertas/{id}`, sin `page.tsx`) y daba 404 desde los pasos 2 a 4.
 *
 * Extraído de `app/admin/ofertas/[id]/editar/page.tsx` (N-01.0b): esa ruta ahora sólo
 * importa y renderiza `EditarOferta`.
 */
export default async function EditarOferta({
  params,
  searchParams,
}: {
