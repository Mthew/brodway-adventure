...
import { Avance } from "@/src/platform/admin/piezas";
 ...
 *
 * Extraído de `app/admin/ofertas/[id]/publicar/page.tsx` (N-01.0b): esa ruta ahora
 * sólo importa y renderiza `PublicarOferta`.
 */
export default async function PublicarOferta({
  params,
}: {
