...
import { Avance, BarraAccion, ENTRADA } from "@/src/platform/admin/piezas";
 ...
 *
 * Extraído de `app/admin/ofertas/[id]/fotos/page.tsx` (N-01.0b): esa ruta ahora sólo
 * importa y renderiza `FotosOferta`.
 */
export default async function FotosOferta({
  params,
}: {
